import { Component as C, Fragment as S, cloneElement as W$1, createContext as X, createElement as k, createRef as M$1, hydrate as U$1, options as l, render as R$1, toChildArray as F$2 } from "./preact.js";
import { useCallback as q, useContext as x$1, useDebugValue as P$1, useEffect as h, useErrorBoundary as b, useId as g, useImperativeHandle as F, useLayoutEffect as _, useMemo as T, useReducer as y, useRef as A, useState as d } from "./preact_hooks.js";
...
function N(n, e) {
	...
	function u(e) {
		return this.shouldComponentUpdate = r, k(n, e);
	}
...
function Y(n) {
	...
	R$1(k(Z, { context: e.context }, n.__v), e.v);
}
function $(n, e) {
	var r = k(Y, {
		__v: n,
	...
	"string" == typeof n.type && function(n) {
		...
		for (var i in t) {
			...
			if (!("value" === i && "defaultValue" in t && null == l || Q && "children" === i && "noscript" === e || "class" === i || "className" === i)) {
				var f = i.toLowerCase();
				"defaultValue" === i && "value" in t && null == t.value ? i = "value" : "download" === i && !0 === l ? l = "" : "translate" === f && "no" === l ? l = !1 : "o" === f[0] && "n" === f[1] ? "ondoubleclick" === f ? i = "ondblclick" : "onchange" !== f || "input" !== e && "textarea" !== e || X$1(t.type) ? "onfocus" === f ? i = "onfocusin" : "onblur" === f ? i = "onfocusout" : J.test(i) && (i = f) : f = i = "oninput" : o && G.test(i) ? i = i.replace(K, "-$&").toLowerCase() : null === l && (l = void 0), "oninput" === f && u[i = f] && (i = "oninputCapture"), u[i] = l;
			}
		}
...
var bn = function(n, t) {
	...
	l.debounceRendering = function(n) {
		r = n;
	};
	try {
		var o = n(t);
...
//#endregion
export { L as Children, C as Component, S as Fragment, S as StrictMode, M as PureComponent, P as Suspense, B as SuspenseList, an as __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED, mn as cloneElement, X as createContext, k as createElement, sn as createFactory, $ as createPortal, M$1 as createRef, gn as default, yn as findDOMNode, bn as flushSync, D as forwardRef, tn as hydrate, Sn as isElement, vn as isFragment, dn as isMemo, hn as isValidElement, z as lazy, N as memo, nn as render, x as startTransition, pn as unmountComponentAtNode, _n as unstable_batchedUpdates, q as useCallback, x$1 as useContext, P$1 as useDebugValue, w as useDeferredValue, h as useEffect, b as useErrorBoundary, g as useId, F as useImperativeHandle, I as useInsertionEffect, _ as useLayoutEffect, T as useMemo, y as useReducer, A as useRef, d as useState, C$1 as useSyncExternalStore, k$1 as useTransition, cn as version };
